...
const HeroSection: React.FC = () => {
  return (
    <section id="hero" className="min-h-screen flex items-center pt-16 bg-gradient-to-br from-white via-green-50 to-blue-50">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <div className="animate-fade-in">
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold mb-6">
              Machine Learning for 
              <span className="text-research-green block mt-2">Vegetable Price Prediction</span>
            </h1>
            <p className="text-lg md:text-xl text-research-gray mb-8 max-w-xl">
              Leveraging advanced machine learning algorithms to predict vegetable prices,
              helping farmers and distributors make informed decisions in the agricultural market.
            </p>
              ...
              <div className="relative z-10 bg-white p-6 rounded-lg shadow-xl">
                ...
                <div className="mt-4 grid grid-cols-2 gap-4">
                  <div className="bg-blue-50 p-3 rounded-md">
                    ...
                    <p className="text-sm text-research-gray">Prediction Accuracy</p>
                  </div>
                  <div className="bg-green-50 p-3 rounded-md">
                    <h4 className="font-bold text-research-green">10+</h4>
                    <p className="text-sm text-research-gray">ML Models Tested</p>
                  </div>
                </div>
              </div>
